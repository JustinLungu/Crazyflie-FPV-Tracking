...
import cflib.crtp
#class is used to easily connect/send/receive data from a Crazyflie.
from cflib.crazyflie import Crazyflie
from cflib.crazyflie.syncCrazyflie import SyncCrazyflie

#class is a representation of one log configuration that enables logging from the Crazyflie
from cflib.crazyflie.log import LogConfig
#class provides synchronous access to log data from the Crazyflie.
...
# or just
uri = 'radio://0/80/250K/E7E7E7E7E3'
